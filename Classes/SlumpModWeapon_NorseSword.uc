...
*/
class SlumpModWeapon_NorseSword extends AOCWeapon_NorseSword;
...
DefaultProperties
{
	...
	AttachmentClass=class'SlumpModWeaponAttachment_NorseSword'
	...
	ReleaseAnimations(0)=(AnimationName=3p_1hsharp_slash01release,ComboAnimation=3p_1hsharp_slash011release,AlternateAnimation=3p_1hsharp_slash011release,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.broadsword_attack_01',bFullBody=true,bCombo=False,bLoop=False,bForce=false,UniqueShieldSound=none,fModifiedMovement=1.0,fAnimationLength=0.35,fBlendInTime=0.1,fBlendOutTime=0.1,bLastAnimation=false)
