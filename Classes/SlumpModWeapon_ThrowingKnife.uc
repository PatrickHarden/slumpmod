...
*/
class SlumpModWeapon_ThrowingKnife extends SlumpModThrowableWeapon;
...
DefaultProperties
{
	...
	WeaponProjectiles(0)=class'SlumpModProj_ThrownDagger'

	AttachmentClass=class'SlumpModWeaponAttachment_ThrowingKnife'
	 ...
	 */
	ConfigProjectileBaseDamage[0]=(Damage=0,InitialSpeed=0,MaxSpeed=0,AmmoCount=1,InitialGravityScale=0,Drag=0,PitchCorrection=0.0)
	ConfigProjectileBaseDamage[1]=(Damage=0,InitialSpeed=0,MaxSpeed=0,AmmoCount=1,InitialGravityScale=0,Drag=0,PitchCorrection=0.0)
	ConfigProjectileBaseDamage[2]=(Damage=0,InitialSpeed=0,MaxSpeed=0,AmmoCount=1,InitialGravityScale=0,Drag=0,PitchCorrection=0.0)
	ConfigProjectileBaseDamage[3]=(Damage=0,InitialSpeed=0,MaxSpeed=0,AmmoCount=1,InitialGravityScale=0,Drag=0,PitchCorrection=0.0)
	ConfigProjectileBaseDamage[4]=(Damage=0,InitialSpeed=0,MaxSpeed=0,AmmoCount=1,InitialGravityScale=0,Drag=0,PitchCorrection=0.0)
	ConfigProjectileBaseDamage[5]=(Damage=38,InitialSpeed=2700.0,MaxSpeed=3000.0,AmmoCount=2,InitialGravityScale=0.90,Drag=0.000005,PitchCorrection=200)
	iFeintStaminaCost=20
	WeaponFontSymbol="S"
	WeaponReach=100
	...
	HorizontalRotateSpeed=95000.0
	VerticalRotateSpeed=85000.0
	...
	WindupAnimations(0)=(AnimationName=3p_throwingknife_downtoup,ComboAnimation=,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.shortsword_windup',bFullBody=False,bCombo=False,bLoop=False,bForce=false,fModifiedMovement=1.0,fAnimationLength=0.6,fBlendInTime=0.00,fBlendOutTime=0.00,bLastAnimation=false)
	...
	RecoveryAnimations(0)=(AnimationName=3p_throwingknife_recover,ComboAnimation=3p_throwingknife_slash011recover,AssociatedSoundCue=,bFullBody=false,bCombo=false,bLoop=false,bForce=false,UniqueShieldSound=none,fModifiedMovement=1.0,fAnimationLength=0.2,fBlendInTime=0.00,fBlendOutTime=0.0,bLastAnimation=true)
