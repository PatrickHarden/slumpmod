...
* Warbow.
*/
class SlumpModWeapon_Warbow extends SlumpModWeapon_Longbow;
...
DefaultProperties
{
	...
	// 0 - Bodkin
 	...
 	// 5 - Default
	// 6 - Warbow arrow
	ConfigProjectileBaseDamage[0]=(Damage=54,InitialSpeed=3500.0,MaxSpeed=3500.0,AmmoCount=20,InitialGravityScale=0.85,Drag=0.000005,PitchCorrection=50)
	ConfigProjectileBaseDamage[1]=(Damage=62,InitialSpeed=3500.0,MaxSpeed=3500.0,AmmoCount=20,InitialGravityScale=0.85,Drag=0.000005,PitchCorrection=50)
	ConfigProjectileBaseDamage[2]=(Damage=30,InitialSpeed=6000.0,MaxSpeed=6500,AmmoCount=15,InitialGravityScale=0.85,Drag=0.000005,PitchCorrection=240.0)
	...
	ConfigProjectileBaseDamage[6]=(Damage=54,InitialSpeed=3500.0,MaxSpeed=3500.0,AmmoCount=20,InitialGravityScale=0.85,Drag=0.000005,PitchCorrection=50)
	iFeintStaminaCost=0
	WeaponFontSymbol="@"
	WeaponReach=100
	...
	WindupAnimations(0)=(AnimationName=3p_longbow_draw,ComboAnimation=,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.Warbow_Reload',bFullBody=False,bCombo=False,bLoop=False,bForce=false,fModifiedMovement=0.45,fAnimationLength=1.5,fBlendInTime=0.10,fBlendOutTime=0.00,bLastAnimation=false,bPlayOnWeapon=true,bUseAltNode=true)
