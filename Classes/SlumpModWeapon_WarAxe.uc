...
*/
class SlumpModWeapon_WarAxe extends SlumpModMeleeWeapon;
...
DefaultProperties
{
	...
	AttachmentClass=class'SlumpModWeaponAttachment_WarAxe'
	...
	ReleaseAnimations(0)=(AnimationName=3p_1hsharp_slash01release,ComboAnimation=3p_1hsharp_slash011release,AlternateAnimation=3p_1hsharp_slash011release,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.WarAxe_attack_01',bFullBody=true,bCombo=False,bLoop=False,bForce=false,UniqueShieldSound=none,fModifiedMovement=1.0,fAnimationLength=0.425,fBlendInTime=0.00,fBlendOutTime=0.00,bLastAnimation=false)
