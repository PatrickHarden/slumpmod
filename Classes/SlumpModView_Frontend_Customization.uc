class SlumpModView_Frontend_Customization extends AOCView_Frontend_Customization
config(SlumpModCustomization);
...
function PopulateCustomizationInfoArrays()
{
	...
	//temp = class'SlumpModCustomization'.static.CheckMicroTxOwnership(1, repInfo);
	//class'WorldInfo'.static.GetWorldInfo().Spawn.
	for(i = 0; i < 4; ++i)
	{
		TeamCustomizationChoices[EFAC_Agatha].ClassCustomizationChoices[i] = class'SlumpModCustomization'.static.LocalGetCustomizationChoices(EFAC_Agatha, i);
		TeamCustomizationChoices[EFAC_Mason].ClassCustomizationChoices[i] = class'SlumpModCustomization'.static.LocalGetCustomizationChoices(EFAC_Mason, i);
		TeamCustomizationChoices[EFAC_FFA].ClassCustomizationChoices[i] = class'SlumpModCustomization'.static.LocalGetCustomizationChoices(EFAC_FFA, i);
	}

	for(i = 0; i < 4; ++i)
	{
		class'SlumpModCustomization'.static.LocalGetSelectedWeaponDrops(EFAC_MASON, i, TeamWeaponChoices[EFAC_MASON].Classes[i].Weapons, AOCPRI(repInfo));
		class'SlumpModCustomization'.static.LocalGetSelectedWeaponDrops(EFAC_AGATHA, i, TeamWeaponChoices[EFAC_AGATHA].Classes[i].Weapons, AOCPRI(repInfo));
		class'SlumpModCustomization'.static.LocalGetSelectedWeaponDrops(EFAC_FFA, i, TeamWeaponChoices[EFAC_FFA].Classes[i].Weapons, AOCPRI(repInfo));
	}

	FactionSupportFavIconId = class'SlumpModCustomization'.static.LocalGetFactionSupporterId();
}
...
function SaveChoices()
{
	...
	for(i = 0; i < 4; ++i)
	{
		class'SlumpModCustomization'.static.LocalSetCustomizationChoices(TeamCustomizationChoices[EFAC_Agatha].ClassCustomizationChoices[i], EFAC_Agatha, i, TeamWeaponChoices[EFAC_AGATHA].Classes[i].Weapons, FactionSupportFavIconId);
		class'SlumpModCustomization'.static.LocalSetCustomizationChoices(TeamCustomizationChoices[EFAC_Mason].ClassCustomizationChoices[i], EFAC_Mason, i, TeamWeaponChoices[EFAC_Mason].Classes[i].Weapons, FactionSupportFavIconId);
		class'SlumpModCustomization'.static.LocalSetCustomizationChoices(TeamCustomizationChoices[EFAC_FFA].ClassCustomizationChoices[i], EFAC_FFA, i, TeamWeaponChoices[EFAC_FFA].Classes[i].Weapons, FactionSupportFavIconId);
	}
...
function OnFadeOutDone()
{
	...
	PreviewPawn = class'WorldInfo'.static.GetWorldInfo().Spawn(class'SlumpModPreviewPawn',,,PawnLocation);
...
function GFxObject PopulatePatternList(int CharID, out float selectedIndex)
{
	...
	if(RightTabMode == RTAB_Pattern)
	{
		...
		IDs = class'SlumpModCustomization'.static.GetAllTabardsFor(CharID);
		i = 0;
		foreach IDs(GearID)
		{
			MicroTxID = 0;
			...
			bIsOwned = class'SlumpModCustomization'.static.IsTabardOwnedBy(GearID, CharID, class'WorldInfo'.static.GetWorldInfo().GetALocalPlayerController().PlayerReplicationInfo, SelectedClass);
			if(bIsOwned || class'SlumpModCustomization'.static.IsTabardVisibleIfUnowned(GearID, CharID))
			{
				IndvElement = CreateObject("Object");
				IndvElement.SetInt("tabardID", GearID);
				IndvElement.SetBool("isLocked", !bIsOwned);
				class'SlumpModCustomization'.static.GetTabardStoreDescription(GearID, CharID, bPromptToBuy, Price, MicroTxID, PurchaseName);
				...
				DiscountPercent = "";
				if(class'SlumpModCustomization'.static.IsMicroTxnItemOnSale(MicroTxID, Price, DiscountPercent))
				{
				...
				else
				{
					...
					if(class'SlumpModCustomization'.static.IsMicroTxnItemNew(MicroTxID))
					{
				...
				IndvElement.SetString("itemName", DiscountPercent@class'SlumpModCustomization'.static.GetTabardName(GearID, CharID));
				...
				if(GearID == TeamCustomizationChoices[SelectedTeam].ClassCustomizationChoices[SelectedClass].Tabard)
				{
					...
					selectedIndex = i;
					SetItemNameLabel(class'SlumpModCustomization'.static.GetTabardName(GearID, CharID));
				}
...
function GFxObject PopulateShieldList(int CharID, out float selectedIndex)
{
	...
	if(RightTabMode == RTAB_Shield)
	{
		...
		{
			class'SlumpModCustomization'.static.GetShieldDisplayInfo(TeamWeaponChoices[SelectedTeam].Classes[SelectedClass].Weapons[SelectedWeapon], class<AOCWeapon_Shield>(WeaponClasses[SelectedWeapon]).default.Shield, AllowedTeams, SkeletalMeshPath, StaticMeshPath, MaterialPath, bUseDefaultParameters, WeaponParameterSets, ShieldPatternNames, ShieldPatternPaths);
		...
		{
			IDs = class'SlumpModCustomization'.static.GetAllShieldPatternsFor(CharID);
			i = 0;
			foreach IDs(GearID)
			{
				MicroTxID = 0;
				...
				bIsOwned = class'SlumpModCustomization'.static.IsShieldPatternOwnedBy(GearID, CharID, class'WorldInfo'.static.GetWorldInfo().GetALocalPlayerController().PlayerReplicationInfo, SelectedClass);
				if(bIsOwned || class'SlumpModCustomization'.static.IsShieldPatternVisibleIfUnowned(GearID, CharID))
				{
					IndvElement = CreateObject("Object");
					IndvElement.SetInt("shieldID", GearID);
					IndvElement.SetBool("isLocked", !bIsOwned);
					class'SlumpModCustomization'.static.GetShieldStoreDescription(GearID, CharID, bPromptToBuy, Price, MicroTxID, PurchaseName);
					...
					IndvElement.SetBool("isPurchasable", Bool(bPromptToBuy) && !bIsOwned);
					IndvElement.SetString("price", Price);
					IndvElement.SetString("itemName", DiscountPercent@class'SlumpModCustomization'.static.GetShieldPatternName(GearID, CharID));
					IndvElement.SetInt("microTxnId", MicroTxID);
					ListDataProvider.SetElementObject(i, IndvElement);
					...
					if(GearID == TeamCustomizationChoices[SelectedTeam].ClassCustomizationChoices[SelectedClass].Shield)
					{
						ShowBuyButton(Bool(bPromptToBuy) && !bIsOwned, Price);
						selectedIndex = i;
						SetItemNameLabel(class'SlumpModCustomization'.static.GetShieldPatternName(GearID, CharID));
					}
...
function GFxObject PopulateEmblemList(out float selectedIndex)
{
	...
	if(RightTabMode == RTAB_Emblem)
	{
		...
		IDs = class'SlumpModCustomization'.static.GetAllEmblemsFor(SelectedTeam);
		i = 0;
		foreach IDs(GearID)
		{
			MicroTxID = 0;
			...
			PurchaseName = "";
			Price = "";
			bIsMicoTxnVisible = class'SlumpModCustomization'.static.IsMicroTxnEmblemVisible(GearID, SelectedTeam, class'WorldInfo'.static.GetWorldInfo().GetALocalPlayerController().PlayerReplicationInfo);

			if(bIsMicoTxnVisible)
			{
				bIsOwned = class'SlumpModCustomization'.static.IsEmblemOwnedBy(GearID, SelectedTeam, class'WorldInfo'.static.GetWorldInfo().GetALocalPlayerController().PlayerReplicationInfo, SelectedClass);
				if(bIsOwned || class'SlumpModCustomization'.static.IsEmblemVisibleIfUnowned(GearID, SelectedTeam))
				{
					IndvElement = CreateObject("Object");
					IndvElement.SetInt("emblemID", GearID);
					IndvElement.SetBool("isLocked", !bIsOwned);
					class'SlumpModCustomization'.static.GetEmblemStoreDescription(GearID, SelectedTeam, bPromptToBuy, Price, MicroTxID, PurchaseName);
					...
					IndvElement.SetBool("isPurchasable", Bool(bPromptToBuy) && !bIsOwned);
					IndvElement.SetInt("microTxnId", MicroTxID);
					IndvElement.SetString("itemName", DiscountPercent@class'SlumpModCustomization'.static.GetEmblemName(GearID, SelectedTeam));
					ListDataProvider.SetElementObject(i, IndvElement);
					...
					if(GearID == TeamCustomizationChoices[SelectedTeam].ClassCustomizationChoices[SelectedClass].Emblem)
					{
						ShowBuyButton(Bool(bPromptToBuy) && !bIsOwned, Price);
						selectedIndex = i;
						SetItemNameLabel(class'SlumpModCustomization'.static.GetEmblemName(GearID, SelectedTeam));
					}
	...
	if(RightTabMode == RTAB_Weapon)
	{
		...
		foreach ClassWeapons(WeaponClass)
		{
			...
			if(AllOwnedOrPurchasableWeaponDrops[WeaponClass.default.CurrentWeaponType].Items.Length > 0)
			{
				...
				//class'SlumpModCustomization'.static.GetWeaponSkinStoreDescription(GearID, CharacterID, bPromptToBuy, Price, MicroTxID, PurchaseName);
				...
				{
					if(class'SlumpModCustomization'.static.IsMicroTxnItemOnSale(WeaponItem.GearData.MicroTxID, Price, DiscountPercent))
					{
						IsOnSale = true;
					}
					else if(class'SlumpModCustomization'.static.IsMicroTxnItemNew(WeaponItem.GearData.MicroTxID))
					{
						IsNew = true;
					}
...
function GFxObject PopulateHelmetList(int CharID, out float selectedIndex)
{
	...
	if(RightTabMode == RTAB_Helmet)
	{
		...
		IDs = class'SlumpModCustomization'.static.GetAllHelmetsFor(CharID);
		i = 0;
		foreach IDs(GearID)
		{
			MicroTxID = 0;
			...
			bIsOwned = class'SlumpModCustomization'.static.IsHelmetOwnedBy(GearID, CharID, class'WorldInfo'.static.GetWorldInfo().GetALocalPlayerController().PlayerReplicationInfo, SelectedClass);

			bIsMicoTxnVisible = class'SlumpModCustomization'.static.IsMicroTxnHelmetVisible(GearID, CharID, class'WorldInfo'.static.GetWorldInfo().GetALocalPlayerController().PlayerReplicationInfo);

			if(bIsMicoTxnVisible)
			{
				if(bIsOwned || class'SlumpModCustomization'.static.IsHelmetVisibleIfUnowned(GearID, CharID))
				{
					IndvElement = CreateObject("Object");
					IndvElement.SetInt("helmetID", GearID);
					IndvElement.SetBool("isLocked", !bIsOwned);
					class'SlumpModCustomization'.static.GetHelmetStoreDescription(GearID, CharID, bPromptToBuy, Price, MicroTxID, PurchaseName);
					...
					IndvElement.SetBool("isPurchasable", Bool(bPromptToBuy) && !bIsOwned);
					IndvElement.SetInt("microTxnId", MicroTxID);
					IndvElement.SetString("itemName", DiscountPercent@class'SlumpModCustomization'.static.GetHelmetName(GearID,TeamCustomizationChoices[SelectedTeam].ClassCustomizationChoices[SelectedClass].Character));
					ListDataProvider.SetElementObject(i, IndvElement);
					...
					if(GearID == TeamCustomizationChoices[SelectedTeam].ClassCustomizationChoices[SelectedClass].Helmet)
					{
						ShowBuyButton(Bool(bPromptToBuy) && !bIsOwned, Price);
						selectedIndex = i;
						SetItemNameLabel(class'SlumpModCustomization'.static.GetHelmetName(GearID,TeamCustomizationChoices[SelectedTeam].ClassCustomizationChoices[SelectedClass].Character));
					}
...
function GFxObject PopulateArmourList(out float selectedIndex)
{
	...
	if(RightTabMode == RTAB_Armour)
	{
		...
		IDs = class'SlumpModCustomization'.static.GetAllCharactersFor(SelectedTeam, SelectedClass);
		i = 0;
		foreach IDs(GearID)
		{
			MicroTxID = 0;
			...
			bIsOwned = class'SlumpModCustomization'.static.IsCharacterOwnedBy(GearID, SelectedTeam, SelectedClass, class'WorldInfo'.static.GetWorldInfo().GetALocalPlayerController().PlayerReplicationInfo);
			bIsMicoTxnVisible = class'SlumpModCustomization'.static.IsMicroTxnCharacterVisible(GearID, SelectedTeam, SelectedClass, class'WorldInfo'.static.GetWorldInfo().GetALocalPlayerController().PlayerReplicationInfo);

			if(bIsMicoTxnVisible)
			{
				if(bIsOwned || class'SlumpModCustomization'.static.IsCharacterVisibleIfUnowned(GearID, SelectedTeam, SelectedClass))
				{
					IndvElement = CreateObject("Object");
					IndvElement.SetInt("characterID", GearID);
					IndvElement.SetBool("isLocked", !bIsOwned);
					class'SlumpModCustomization'.static.GetCharacterStoreDescription(GearID, bPromptToBuy, Price, MicroTxID, PurchaseName);
					...
					IndvElement.SetBool("isPurchasable", Bool(bPromptToBuy) && !bIsOwned);
					IndvElement.SetInt("microTxnId", MicroTxID);
					IndvElement.SetString("itemName", DiscountPercent@class'SlumpModCustomization'.static.GetCharacterName(GearID));
					ListDataProvider.SetElementObject(i, IndvElement);
					...
					if(GearID == TeamCustomizationChoices[SelectedTeam].ClassCustomizationChoices[SelectedClass].Character)
					{
						ShowBuyButton(Bool(bPromptToBuy) && !bIsOwned, Price);
						selectedIndex = i;
						SetItemNameLabel(class'SlumpModCustomization'.static.GetCharacterName(GearID));
					}		
	...
	if(RightTabMode == RTAB_Weapon)
	{
		...
		foreach Weapons.Items(Weapon)
		{
			...
			if(bIsMicoTxnVisible && (SelectedTeam == EFAC_FFA || WeaponItemInfo.AllowedTeams.Find(SelectedTeam) != INDEX_NONE))
			{
				...
				{
					IndvElement = CreateObject("Object");
					class'SlumpModCustomization'.static.GetGearStoreDescription(Weapon.GearData, bPromptToBuy, Price, MicroTxID, PurchaseName);

					DiscountPercent = "";
					if(class'SlumpModCustomization'.static.IsMicroTxnItemOnSale(Weapon.GearData.MicroTxID, Price, DiscountPercent))
					{
						IndvElement.SetBool("isItemOnSale", true);
						IndvElement.SetBool("isNewItem", false);
						AddItemToNotificationArray(MicroTxID);
					...
					{
						IndvElement.SetBool("isItemOnSale", false);
						if(class'SlumpModCustomization'.static.IsMicroTxnItemNew(Weapon.GearData.MicroTxID))
						{
							IndvElement.SetBool("isNewItem", true);
							AddItemToNotificationArray(MicroTxID);
						}
...
function SetupColors(optional bool UpdateSwatch1 = true, optional bool UpdateSwatch2 = true, optional bool UpdateSwatch3 = true)
{
	...
	{		
		NumberOfEmblemColours = class'SlumpModCustomization'.static.GetNumberOfEmblemColours(SelectedTeam);
		NumberOfTabardColours = class'SlumpModCustomization'.static.GetNumberOfTabardColours(ColourSwatchIndex, SelectedTeam);
		...
		for(j = 0; j < (RightTabMode == RTAB_Emblem) ? NumberOfEmblemColours : NumberOfTabardColours; ++j)
		{
			...
			if(RightTabMode == RTAB_Emblem)
			{
				swatchColour = class'SlumpModCustomization'.static.ConvertEmblemColorIndexToColor(j, SelectedTeam);
			...
			{
				swatchColour = class'SlumpModCustomization'.static.ConvertTabardColorIndexToColor(j, SelectedTeam, ColourSwatchIndex);
				ColourObj.SetInt("ra", swatchColour.R);
				ColourObj.SetInt("ba", swatchColour.B);
				ColourObj.SetInt("ga", swatchColour.G);
				SwatchPopup[ColourSwatchIndex].AddColour(ColourObj);
...
function OnRightListItemClicked(GFxClikWidget.EventData Params)
{
	...
	if(RightTabMode == RTAB_Pattern)
	{
		...
		SetItemNameLabel(class'SlumpModCustomization'.static.GetTabardName(GearID, CharacterID));
	}
	...
	else if(RightTabMode == RTAB_Shield)
	{
		...
		SetItemNameLabel(class'SlumpModCustomization'.static.GetShieldPatternName(GearID, CharacterID));
	}
	...
	else if(RightTabMode == RTAB_Helmet)
	{
		...
		SetItemNameLabel(class'SlumpModCustomization'.static.GetHelmetName(GearID,CharacterID));
		FullPawnRefresh = true;
		FullRefreshDisplayedPawn();
	}
...
function CheckLocks()
{
	...
	if(RightTabMode == RTAB_Emblem && !class'SlumpModCustomization'.static.IsEmblemOwnedBy(TeamCustomizationChoices[SelectedTeam].ClassCustomizationChoices[SelectedClass].Emblem, SelectedTeam, class'WorldInfo'.static.GetWorldInfo().GetALocalPlayerController().PlayerReplicationInfo, SelectedClass))
	{
		LockText = class'SlumpModCustomization'.static.GetEmblemStoreDescription(TeamCustomizationChoices[SelectedTeam].ClassCustomizationChoices[SelectedClass].Emblem, SelectedTeam, bPromptToBuy, DisplayedMicroTxPurchasePrice, DisplayedMicroTxID, DisplayedMicroTxPurchaseName); 
	}
	else if(RightTabMode == RTAB_Armour && !class'SlumpModCustomization'.static.IsCharacterOwnedBy(CharacterID, SelectedTeam, SelectedClass, class'WorldInfo'.static.GetWorldInfo().GetALocalPlayerController().PlayerReplicationInfo))
	{
		LockText = class'SlumpModCustomization'.static.GetCharacterStoreDescription(CharacterID, bPromptToBuy, DisplayedMicroTxPurchasePrice, DisplayedMicroTxID, DisplayedMicroTxPurchaseName); 
	}
	else if(RightTabMode == RTAB_Pattern && !class'SlumpModCustomization'.static.IsTabardOwnedBy(TeamCustomizationChoices[SelectedTeam].ClassCustomizationChoices[SelectedClass].Tabard, TeamCustomizationChoices[SelectedTeam].ClassCustomizationChoices[SelectedClass].Character, class'WorldInfo'.static.GetWorldInfo().GetALocalPlayerController().PlayerReplicationInfo, SelectedClass))
	{
		LockText = class'SlumpModCustomization'.static.GetTabardStoreDescription(TeamCustomizationChoices[SelectedTeam].ClassCustomizationChoices[SelectedClass].Tabard, CharacterID, bPromptToBuy, DisplayedMicroTxPurchasePrice, DisplayedMicroTxID, DisplayedMicroTxPurchaseName);
	}
	else if(RightTabMode == RTAB_Shield && !class'SlumpModCustomization'.static.IsShieldPatternOwnedBy(TeamCustomizationChoices[SelectedTeam].ClassCustomizationChoices[SelectedClass].Shield, CharacterID, class'WorldInfo'.static.GetWorldInfo().GetALocalPlayerController().PlayerReplicationInfo, SelectedClass))
	{
		LockText = class'SlumpModCustomization'.static.GetShieldStoreDescription(TeamCustomizationChoices[SelectedTeam].ClassCustomizationChoices[SelectedClass].Shield, CharacterID, bPromptToBuy, DisplayedMicroTxPurchasePrice, DisplayedMicroTxID, DisplayedMicroTxPurchaseName);
	}
	else if(RightTabMode == RTAB_Helmet && !class'SlumpModCustomization'.static.IsHelmetOwnedBy(TeamCustomizationChoices[SelectedTeam].ClassCustomizationChoices[SelectedClass].Helmet, CharacterID, class'WorldInfo'.static.GetWorldInfo().GetALocalPlayerController().PlayerReplicationInfo, SelectedClass))
	{
		LockText = class'SlumpModCustomization'.static.GetHelmetStoreDescription(TeamCustomizationChoices[SelectedTeam].ClassCustomizationChoices[SelectedClass].Helmet, CharacterID, bPromptToBuy, DisplayedMicroTxPurchasePrice, DisplayedMicroTxID, DisplayedMicroTxPurchaseName); 
	}
		    ...
		    !AOCPlayerController(GetPC()).OwnsWeaponDrop(TeamWeaponChoices[SelectedTeam].Classes[SelectedClass].Weapons[SelectedWeapon]))
	{
		...
		if(DropInfo.GearData.AppIDNoDLC > 0)
		{
			...
			{
				bLocked = !class'SlumpModCustomization'.static.IsGearOwnedBy(DropInfo.GearData, class'WorldInfo'.static.GetWorldInfo().GetALocalPlayerController().PlayerReplicationInfo, SelectedClass);
				if(bLocked)
					LockText = class'SlumpModCustomization'.static.GetGearStoreDescription(DropInfo.GearData, bPromptToBuy, DisplayedMicroTxPurchasePrice, DisplayedMicroTxID, DisplayedMicroTxPurchaseName);
			}
			else
				bLocked = false;
		}
