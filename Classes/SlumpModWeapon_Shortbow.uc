...
* Longbow.
*/
class SlumpModWeapon_Shortbow extends SlumpModWeapon_Longbow
	dependson(AOCPawn);
...
DefaultProperties
{
	 ...
	 */
	ConfigProjectileBaseDamage[0]=(Damage=29,InitialSpeed=3500.0,MaxSpeed=3500.0,AmmoCount=45,InitialGravityScale=0.85,Drag=0.000005,PitchCorrection=50)
	ConfigProjectileBaseDamage[1]=(Damage=32,InitialSpeed=3500.0,MaxSpeed=3500.0,AmmoCount=45,InitialGravityScale=0.85,Drag=0.000005,PitchCorrection=0)
	ConfigProjectileBaseDamage[2]=(Damage=10,InitialSpeed=3500.0,MaxSpeed=3500.0,AmmoCount=15,InitialGravityScale=0.85,Drag=0.000005,PitchCorrection=0)
	...
	WindupAnimations(0)=(AnimationName=3p_longbow_draw,ComboAnimation=,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.shortbow_Reload',bFullBody=False,bCombo=False,bLoop=False,bForce=false,fModifiedMovement=0.90,fAnimationLength=0.9,fBlendInTime=0.10,fBlendOutTime=0.00,bLastAnimation=false,bPlayOnWeapon=true,bUseAltNode=true)
