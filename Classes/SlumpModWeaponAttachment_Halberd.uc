...
*/
class SlumpModWeaponAttachment_Halberd extends AOCWeaponAttachment_Halberd;
...
KickOffset=(X=50, Y=0, Z=-65)
	...
	WeaponClass=class'SlumpModWeapon_Halberd'
	...
	AttackTypeInfo(2)=(fBaseDamage=72.0, fForce=0, cDamageType="AOC.AOCDmgType_Pierce", iWorldHitLenience=6)
