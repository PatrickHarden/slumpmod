...
class SlumpModWeapon_ThrowingAxe extends SlumpModThrowableWeapon;
...
DefaultProperties
{
	...
	AttachmentClass=class'SlumpModWeaponAttachment_ThrownAxe'
	...
	RecoveryAnimations(0)=(AnimationName=3p_1hsharp_throwrecover,ComboAnimation=3p_1hsharp_slash011recover,AssociatedSoundCue=,bFullBody=false,bCombo=false,bLoop=false,bForce=false,UniqueShieldSound=none,fModifiedMovement=1.0,fAnimationLength=1.0,fBlendInTime=0.00,fBlendOutTime=0.0,bLastAnimation=true)
