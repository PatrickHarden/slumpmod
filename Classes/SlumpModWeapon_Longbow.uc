...
* Longbow.
*/
class SlumpModWeapon_Longbow extends SlumpModRangeWeapon
	dependson(AOCPawn);
...
DefaultProperties
{
	 ...
	 */
	ConfigProjectileBaseDamage[0]=(Damage=48,InitialSpeed=3500.0,MaxSpeed=3500.0,AmmoCount=25,InitialGravityScale=0.85,Drag=0.0000050,PitchCorrection=50)
	ConfigProjectileBaseDamage[1]=(Damage=50,InitialSpeed=3500.0,MaxSpeed=3500.0,AmmoCount=25,InitialGravityScale=0.85,Drag=0.0000050,PitchCorrection=0)
	ConfigProjectileBaseDamage[2]=(Damage=20,InitialSpeed=3500.0,MaxSpeed=3500.0,AmmoCount=15,InitialGravityScale=0.5,Drag=0.000004,PitchCorrection=0)
