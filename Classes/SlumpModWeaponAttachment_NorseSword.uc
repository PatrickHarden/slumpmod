...
*/
class SlumpModWeaponAttachment_NorseSword extends AOCWeaponAttachment_NorseSword;
...
KickOffset=(X=50, Y=0, Z=-65)
	...
	WeaponID=EWEP_Norse
	WeaponClass=class'SlumpModWeapon_NorseSword'
	...
	AttackTypeInfo(2)=(fBaseDamage=61.0, fForce=18000, cDamageType="AOC.AOCDmgType_Pierce", iWorldHitLenience=6)
