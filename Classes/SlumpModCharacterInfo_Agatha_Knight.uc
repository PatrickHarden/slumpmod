...
class SlumpModCharacterInfo_Agatha_Knight extends AOCCharacterInfo_Agatha_Knight;
defaultproperties
{
	...
	OwnerMeshPath="SlumpCharacters.AgathaKnight1p"
	...
	StandinOwnerMesh=SkeletalMesh'SlumpCharacters.AgathaKnight1p'
